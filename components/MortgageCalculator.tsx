...
export function MortgageCalculator() {
  ...
  const result = useMemo(() => {
    ...
    const payment = freq.accelerated
      ...
      : calculatePayment(principal, rate / 100, amortization, freq.paymentsPerYear);
  ...
  }, [homePrice, downPayment, rate, amortization, frequencyIndex]);
  ...
  return (
    <div className="not-prose rounded-xl border border-black/10 bg-zinc-50 p-6 dark:border-white/10 dark:bg-zinc-900">
      ...
      <p className="mt-1 text-sm text-zinc-500">
        Illustrative estimate. Uses semi-annual compounding, the legal
        standard for Canadian fixed mortgages, and published CMHC insurance
        tiers and minimum down payment rules. Doesn&apos;t include property
        tax, home/condo insurance, or land transfer tax — for exact figures,
        see{" "}
        <a
